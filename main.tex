...
\paragraph{} Linear discriminant analysis (LDA) is a generalization of Fisher's linear discriminant(which is only applicable to 2 class problems), a method used in statistics, pattern recognition, and machine learning to find a linear combination of features that characterizes or separates two or more classes of objects or events.
...
\subsection*{Data Preparation}
\subsubsection*{Preparing NDVI time series data}
