...
\begin{doublespace}
\vspace*{0.2cm}
\begin{center} \textbf{A REPORT} \end{center}
\begin{center} \textbf{ON} \end{center}
...
\textbf{Date of submission:} 22nd June, 2020 \\
...
\end{tabular} 
\end{center}
\textbf{Name of mentor:} Dr. Hari Shanker Srivastava \\
\textbf{Designation of mentor:} Scientist/Engineer - SG. Group Head, Programme Planning and Evaluation Group (PPEG). \\
